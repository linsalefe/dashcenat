...
export function KPICard({
  label, value, icon: Icon, trend, trendValue, previousValue,
  loading = false, className, index = 0,
}: KPICardProps) {
  ...
  return (
    ...
    >
      <Card className={cn(
        ...
        "hover:shadow-[var(--shadow-sm)] hover:-translate-y-0.5 transition-all duration-200",
        className,
      )}>
